...
TemporalProperty1 ==
(
(\E Q \in Quorums : \A a \in Q : \E t \in Time : (state_time' = t) /\ (\E m \in msgs' :  (m.acc = a)))
=> (\E T \in Time : state_time' = T 
                /\ (\E Q \in Quorums : \A a \in Q : \E t \in Time : 
                                      (T > t) /\ (state_time' = t) /\ (\E m \in msgs' : (m.acc = a))))
)
...
/\(
    \A t \in Time:
     \A P \in Proposers:   
         ((state_time' = t 
           /\ \E b \in Ballots :  (\E Q \in Quorums : \A a \in Q : \E m \in msgs' : (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P) /\ (m.acc = a)) 
                                     /\ (\E m \in msgs' : m.type = "2a" /\ m.prop = P /\ m.bal = b)))
        =>
          (\E t2 \in Time:
                 (t2>t
               /\ state_time = t2  
...
/\(
    \A t \in Time:
     \A P \in Proposers:   
         ((state_time' = t 
           /\ (\E Q \in Quorums : \A a \in Q : (\E m \in msgs' : (m.type = "2b") /\ (m.prop = P) /\ (m.acc = a)))))
        =>
          (\E t2 \in Time:
                 (t2>t
               /\ state_time = t2  
...
TemporalProperties == TemporalProperty1 /\ TemporalProperty2 /\ TemporalProperty3
-----------------------------------------------------------------------------
...
\* A single msgs variable also asserts that if a message is delivered, it is delivered to all acceptors at the same time. 
...
Phase1a(p,b,t ) ==               
      /\ \E t2 \in Time : (t2 >= t /\ Send([type |-> "1a", prop |-> p, bal |-> b], t2))
...
Phase1b(a,m,t) == 
 /\ \E t2 \in Time : ( t2 >= t
                   /\ Send([type |-> "1b", prop |-> m.prop, bal |-> m.bal, maxVBal |-> maxVBal[a], 
...
(***************************************************************************)
Phase2a(p,b,v,t) ==
/\ \E t2 \in Time : (t2 >= t /\ Send([type |-> "2a", prop |-> p, bal |-> b, val |-> v], t2))
...
Phase2b(a,m,t) == 
    /\ \E t2 \in Time :
           ( t2 >= t
             /\ Send([type |-> "2b", prop |-> m.prop, bal |-> m.bal, val |-> m.val, acc |-> a], t2)
...
Messages ==      [type : {"1a"}, prop : Proposers, bal : Ballots, dTime : Time]
            \cup [type : {"1b"}, prop : Proposers, bal : Ballots, maxVBal : Ballots \cup {-1},
                    maxVal : Values \cup {None}, acc : Acceptors, dTime : Time]
            \cup [type : {"2a"}, prop : Proposers, bal : Ballots, val : Values, dTime : Time]
            \cup [type : {"2b"}, prop : Proposers, bal : Ballots, val : Values, acc : Acceptors, dTime
             : Time]       
-----------------------------------------------------------------------------
...
( (~(P1=P2)) 
  /\ \E m1, m2 \in msgs :  (m1.type = "1a") /\ (m1.prop = P1) /\ (m2.type = "1a") /\ (m2.prop = P2) /\ (m1.bal>m2.bal) /\ (m1.dTime = m2.dTime) /\ (m1.bal > maxBal[a]))
=>
( (~(P1=P2))
  /\ \E m1, m2 \in msgs :   (m1.type = "1a") /\ (m1.prop = P1) /\ (m2.type = "1a") /\ (m2.prop = P2) /\ (m1.bal>m2.bal) /\ (m1.dTime = m2.dTime) /\ (m1.bal > maxBal[a])
...
\A P1,P2 \in Proposers :
( (~(P1=P2)) 
  /\ \E m1, m2 \in msgs :  (m1.type = "1a") /\ (m1.prop = P1) /\ (m2.type = "1a") /\ (m2.prop = P2) /\ (m1.dTime < m2.dTime) /\ (m1.bal > maxBal[a]))
=>
( (~(P1=P2))
  /\ \E m1, m2 \in msgs :   (m1.type = "1a") /\ (m1.prop = P1) /\ (m2.type = "1a") /\ (m2.prop = P2) /\ (m1.dTime < m2.dTime) /\ (m1.bal > maxBal[a])
                                                                                                                  /\ \E t \in Time : Phase1b(a,m1,t))
...
(\E m \in msgs : (m.type = "1a") /\ m.bal > maxBal[a] /\ m.prop = P /\ m.bal = b)
=> 
(\E m \in msgs : (m.type = "1a") /\ m.bal > maxBal[a] /\ m.prop = P /\ m.bal = b
...
aDelivery == 
 ...
 /\  \A b \in Ballots :\A t \in Time : \A p \in Proposers : 
        Send([type |-> "1a", prop |-> p, bal |-> b], t) => 
           \E t2 \in Time : (t2 > t) /\ Deliver([type |-> "1a", prop |-> p, bal |-> b],t2)                         

     \* 1b msg
 /\  \A Q \in Quorums :  \A a \in Q : \A m \in msgs : 
                         \A t \in Time : Send([type |-> "1b", prop |-> m.prop, bal |-> m.bal, 
                                          maxVBal |-> maxVBal[a], 
                                           maxVal |-> maxVal[a], acc |-> a], t)       
      => 
          \E t2 \in Time : (t2 > t) /\ Deliver([type |-> "1b", prop |-> m.prop, bal |-> m.bal, 
                 maxVBal |-> maxVBal[a], maxVal |-> maxVal[a], acc |-> a], t2)
 
    \* 2a msg
 /\ \A b \in Ballots : \A v \in Values : \A p \in Proposers :
             \A t \in Time : Send([type |-> "2a", prop |-> p, bal |-> b, val |-> v], t)
      =>  
          \E t1 \in Time : (t1 > t) /\ Deliver([type |-> "2a", prop |-> p, bal |-> b, val |-> v], t1)                  

    \* 2b msg
 /\  \A Q \in Quorums : \A a \in Q : \A t \in Time : \A m \in msgs :
        Send([type |-> "2b", prop |-> m.prop, bal |-> m.bal, val |-> m.val, acc |-> a], t)
      =>   
          \E t1 \in Time : (t1 > t) /\ Deliver([type |-> "2b", prop |-> m.prop, bal |-> m.bal, val |-> m.val, acc |-> a], t1) 
...
aPropLimit ==
\A m1, m2 \in msgs : ((m1.prop=m2.prop) => (m1.bal=m2.bal))
\* (~(\E m1, m2 \in msgs : (m1.type ="1a") /\ (m2.type = "1a") /\ (m1.prop=m2.prop) /\ ~(m1=m2)))
...
aNonEmpty ==  (Ballots # {}) \* SInce a proposer has proposed the highest ballot, there is at least one ballot
      ...
      ( \A b \in Ballots :
        (      (\E m1 \in msgs : m1.type = "1a" /\ m1.prop = P /\ m1.bal = b)
           /\ ~(\E m2\in msgs : m2.type = "1b" /\ m2.prop = P /\ m2.bal = b)) 
            => (\A a \in Acceptors : \E m1 \in msgs : m1.type = "1a" /\ m1.prop = P /\ m1.bal = b /\ maxBal[a]<b)  
      ) )
...
\A P \in Proposers :
  ( HighestProposer(P) =>  ( (\E m1 \in msgs :  m1.type = "2a" /\ (m1.prop = P)) 
                               => (\A a \in Acceptors : \E m1 \in msgs : m1.type = "2a" /\ m1.prop = P /\ maxBal[a]<=m1.bal)
                           ) )    
HighestAssertions == 
                     /\ \E P \in Proposers : HighestProposer(P)
                     /\ HighestProposerAssertion1
...
<1> SUFFICES ASSUME NEW P \in Proposers,
                   (\E t \in Time : Available(P,t) /\ state_time = t /\ ~(\E m \in msgs : m.prop = P ))
                   /\ Assumptions
             PROVE (\E t2 \in Time : state_time' = t2 /\ \E b \in Ballots : (\E m \in msgs' : m.type = "1a" /\ m.prop = P /\ m.bal = b)
                                       /\ (~(\E m2 \in msgs': m2.type = "1b" /\ m2.prop = P))
                                       /\ (~(\E m2 \in msgs': m2.type = "2a" /\ m2.prop = P))
                                       /\ (~(\E m2 \in msgs': m2.type = "2b" /\ m2.prop = P)) )          
    OBVIOUS   
...
<1>2a. \E t \in Time : Available(P,t) /\ ~(\E b \in Ballots : \E m \in msgs : m.type = "1a" /\ m.prop = P /\ m.bal = b)
                                      /\ (~(\E m \in msgs: m.type = "1b" /\ m.prop = P))
                                      /\ (~(\E m \in msgs: m.type = "2a" /\ m.prop = P))
                                      /\ (~(\E m \in msgs: m.type = "2b" /\ m.prop = P))                                        
    BY <1>1a 
<1>2b. \E t \in Time : Available(P,t) /\ \A b \in Ballots : ~( \E m \in msgs : m.type = "1a" /\ m.prop = P /\ m.bal = b)
                                      /\ (~(\E m \in msgs: m.type = "1b" /\ m.prop = P))
                                      /\ (~(\E m \in msgs: m.type = "2a" /\ m.prop = P))
                                      /\ (~(\E m \in msgs: m.type = "2b" /\ m.prop = P))                                                                              
    BY <1>2a  
<1>2c. \E t \in Time : Available(P,t) /\ \E b \in Ballots : ~( \E m \in msgs : m.type = "1a" /\ m.prop = P /\ m.bal = b)
                                      /\ (~(\E m \in msgs: m.type = "1b" /\ m.prop = P)) 
                                      /\ (~(\E m \in msgs: m.type = "2a" /\ m.prop = P))
                                      /\ (~(\E m \in msgs: m.type = "2b" /\ m.prop = P))                                                                              
    BY <1>2b, <1>1 DEF aNonEmpty                 
<1>3. \E t \in Time : Available(P,t) /\ \E b \in Ballots : ~( \E m \in msgs : m.type = "1a" /\ m.prop = P /\ m.bal = b)  /\ Rule_1a_msg(P)
                                     /\ (~(\E m \in msgs: m.type = "1b" /\ m.prop = P))  
                                      /\ (~(\E m \in msgs: m.type = "2a" /\ m.prop = P))
                                      /\ (~(\E m \in msgs: m.type = "2b" /\ m.prop = P))                                                                             
...
<1>5. (  \E b \in Ballots :
                          /\ (~ \E m \in msgs : (m.type = "1a") /\ (m.bal = b) ) 
                          /\  \E t \in Time : Send([type |-> "1a", prop |-> P, bal |-> b], t) )
                          /\ (~(\E m \in msgs: m.type = "1b" /\ m.prop = P))
                          /\ (~(\E m \in msgs: m.type = "2a" /\ m.prop = P))
                          /\ (~(\E m \in msgs: m.type = "2b" /\ m.prop = P))                                                                  
    BY <1>4 DEF Phase1a 
<1>6. (  \E b \in Ballots :
                          ...
                          /\ (~(\E m \in msgs: m.type = "2b" /\ m.prop = P))                                                                  
                          /\ (~ \E m \in msgs : (m.type = "1a") /\ (m.bal = b) ) 
                          /\  \E t \in Time : Deliver([type |-> "1a", prop |-> P, bal |-> b], t) )
...
<1>7. (  \E b \in Ballots :
                          ...
                          /\ (~(\E m \in msgs: m.type = "2b" /\ m.prop = P))                                                                  
                          /\ (~ \E m \in msgs : (m.type = "1a") /\ (m.bal = b) ) 
                          /\  \E t \in Time : state_time' = t /\ msgs' = msgs \cup {[type |-> "1a", prop |-> P, bal |-> b]} )
    BY <1>6 DEF Deliver 
<1>7a. (  \E b \in Ballots :
                          /\ (~(\E m \in msgs: m.type = "1b" /\ m.prop = P))
                          /\ (~(\E m \in msgs: m.type = "2a" /\ m.prop = P))
...
<1>8. (  \E b \in Ballots :
                          /\ (~(\E m \in msgs: m.type = "1b" /\ m.prop = P))
                          /\ (~ \E m \in msgs : (m.type = "1a") /\ (m.bal = b) ) 
                          /\  \E t \in Time : state_time' = t /\ [type |-> "1a", prop |-> P, bal |-> b] \in msgs' 
                          /\ (~(\E m \in msgs': m.type = "1b" /\ m.prop = P))
                          /\ (~(\E m \in msgs': m.type = "2a" /\ m.prop = P))
                          /\ (~(\E m \in msgs': m.type = "2b" /\ m.prop = P)))                         
    BY <1>7a             
<1>9. (  \E b \in Ballots :
                          /\ (~ \E m \in msgs : (m.type = "1a") /\ (m.bal = b) ) 
                          /\  \E t \in Time : state_time' = t /\ \E m \in msgs' : m.type = "1a" /\ m.prop = P /\ m.bal = b
                          /\ (~(\E m \in msgs': m.type = "1b" /\ m.prop = P))
                          /\ (~(\E m \in msgs': m.type = "2a" /\ m.prop = P))
                          /\ (~(\E m \in msgs': m.type = "2b" /\ m.prop = P)))
    BY <1>8 
<1>10. \E t \in Time : state_time' = t /\ \E b \in Ballots : \E m \in msgs' : m.type = "1a" /\ m.prop = P /\ m.bal = b
                                       /\ (~(\E m2 \in msgs': m2.type = "1b" /\ m2.prop = P))
                                       /\ (~(\E m2 \in msgs': m2.type = "2a" /\ m2.prop = P))
                                       /\ (~(\E m2 \in msgs': m2.type = "2b" /\ m2.prop = P))                                       
    BY <1>9                          
...
<1> SUFFICES ASSUME NEW P \in Proposers,
                    (\E t \in Time : Available(P,t) 
                                  ...
                                  /\ \E b \in Ballots : (\E Q \in Quorums : \A a \in Q : \E m \in msgs : (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P) /\ (m.acc = a)))                  
                 /\ Assumptions                   
             PROVE  (\E t2 \in Time : state_time' = t2 /\ \E b \in Ballots :  (\E Q \in Quorums : \A a \in Q : \E m \in msgs' : (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P) /\ (m.acc = a))
                                                                             /\ (\E m \in msgs' : m.type = "2a" /\ m.prop = P /\ m.bal = b))   
    OBVIOUS
...
<1>4. (   \E b \in Ballots : (\E Q \in Quorums : \A a \in Q : \E m \in msgs : (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P) /\ (m.acc = a))
          /\ Rule_2a_msg(P))
    BY <1>3
<1>5. (  \E b \in Ballots : (\E Q \in Quorums : \A a \in Q : \E m \in msgs : (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P) /\ (m.acc = a))
              /\ \E v \in Values :                                  
                  \E t2 \in Time : Phase2a(P,b,v,t2) ) 
    BY <1>4 DEF Rule_2a_msg               
<1>6. (  \E b \in Ballots : (\E Q \in Quorums : \A a \in Q : \E m \in msgs : (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P) /\ (m.acc = a))
              /\ \E v \in Values :                                  
                  \E t2 \in Time : Send([type |-> "2a", prop |-> P, bal |-> b, val |-> v], t2)) 
    BY <1>5 DEF Phase2a 
<1>7. (  \E b \in Ballots : (\E Q \in Quorums : \A a \in Q : \E m \in msgs : (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P) /\ (m.acc = a))
              /\ \E v \in Values :                                  
                  \E t2 \in Time : Deliver([type |-> "2a", prop |-> P, bal |-> b, val |-> v], t2)) 
    BY <1>6, <1>1 DEF aDelivery
<1>8.  \E b \in Ballots : (\E Q \in Quorums : \A a \in Q : \E m \in msgs : (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P) /\ (m.acc = a))
              /\ \E v \in Values :                                  
                  \E t2 \in Time : state_time' = t2 /\ msgs' = msgs \cup {[type |-> "2a", prop |-> P, bal |-> b, val |-> v]} 
    BY <1>7 DEF Deliver
<1>9.  \E b \in Ballots : (\E Q \in Quorums : \A a \in Q : \E m \in msgs : (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P) /\ (m.acc = a))
              /\ \E v \in Values :                                  
                  \E t2 \in Time : state_time' = t2 /\ [type |-> "2a", prop |-> P, bal |-> b, val |-> v] \in msgs'     
    BY <1>8
<1>10.  \E b \in Ballots : (\E Q \in Quorums : \A a \in Q : \E m \in msgs : (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P) /\ (m.acc = a))
              /\ \E v \in Values :                                  
                  \E t2 \in Time : state_time' = t2 /\ \E m \in msgs' : m.type = "2a" /\  m.prop = P /\ m.bal = b 
    BY <1>9 
...
(
  ...
  /\ \E b \in Ballots : (\E Q \in Quorums : 
                         \A a \in Q : 
                          \E m \in msgs : 
                            (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P1) /\ (m.acc = a))
                     /\ (\E m \in msgs : (m.type = "2a") /\ (m.prop = P1) /\ (m.bal = b))
  ...
  /\ Assumptions                   
     =>(\E t \in Time : state_time' = t 
                     /\ (\E Q \in Quorums : 
                          \A a \in Q : 
                           (\E m \in msgs' : 
                             (m.type = "2b") /\ (m.prop = P1) /\ (m.acc = a))))
)
<1> SUFFICES ASSUME NEW P1 \in Proposers,
                        (\E b \in Ballots : (\E Q \in Quorums : \A a \in Q : \E m \in msgs : (m.type = "1b") /\ (m.bal = b) /\ (m.prop = P1)/\ (m.acc = a))
                                         /\ (\E m \in msgs : (m.type = "2a") /\ (m.prop = P1) /\ (m.bal = b))
                                         /\ (\A Q \in Quorums : \A a \in Q: (maxBal[a]<=b) )     )
                        /\ Assumptions   
                    PROVE (\E t \in Time : state_time' = t /\ (\E Q \in Quorums : \A a \in Q : (\E m \in msgs' : (m.type = "2b") /\ (m.prop = P1) /\ (m.acc = a))))
    OBVIOUS
<1>1. \E b \in Ballots : 
                      /\ (\E Q \in Quorums : \A a \in Q : \E m \in msgs :  (m.type = "1b") /\ (m.bal = b) /\ (m.prop = P1)/\ (m.acc = a))
                      /\ (\E m \in msgs : (m.type = "2a") /\ (m.prop = P1) /\ (m.bal = b))
                      /\ (\A Q \in Quorums : \A a \in Q: (maxBal[a]<=b) )     
    OBVIOUS
<1>2. ASSUME (~(\E Q \in Quorums : \A a \in Q : \E m \in msgs' : \E t \in Time : (state_time' = t) /\ (m.type = "2b") /\ (m.prop = P1) /\ (m.acc = a)))
      PROVE FALSE
     <2>1. (~(\E Q \in Quorums : \A a \in Q : \E t \in Time : (state_time' = t) /\ (\E m \in msgs' : (m.type = "2b") /\ (m.prop = P1) /\ (m.acc = a))))
          BY <1>2
     ...
     <2>7. \E b \in Ballots : 
                          /\ (\E m \in msgs : (m.type = "2a") /\ (m.prop = P1) /\ (m.bal = b))     
                          /\ \E Q \in Quorums : \A a \in Q : Rule_2b_msg(a) /\ (maxBal[a]<=b) 
          BY <2>6, <1>1
     <2>7a. aTypeOk
          BY DEF Assumptions
     ...
     <2>9. \E b \in Ballots :      
                          \E Q \in Quorums : \A a \in Q :
                                                            Rule_2b_msg(a)  
                                                         /\ \E m \in msgs : (m.type = "2a") /\ (m.prop = P1) /\ (m.bal = b) /\ (maxBal[a]<=m.bal)      
          BY <2>8  
     <2>10. \E Q \in Quorums : \A a \in Q :
                                           Rule_2b_msg(a)  
                                         /\ \E m \in msgs : (m.type = "2a") /\ (m.prop = P1) /\ (maxBal[a]<=m.bal)      
          BY <2>9
     <2>11. \E Q \in Quorums : \A a \in Q :
                                           Rule_2b_msg(a)  
                                         /\ \E m \in msgs : (m.type = "2a") /\ (m.prop = P1) /\ (maxBal[a]<=m.bal)      
                                         /\ \E t \in Time : Phase2b(a,m,t)
          BY <2>10 DEF Rule_2b_msg                               
     <2>12.  \E Q \in Quorums : \A a \in Q :
                                           Rule_2b_msg(a)  
                                         /\ \E m \in msgs : (m.type = "2a") /\ (m.prop = P1) /\ (maxBal[a]<=m.bal)      
                                         /\ \E t \in Time : Send([type |-> "2b", prop |-> m.prop, bal |-> m.bal, val |-> m.val, acc |-> a], t)
          BY <2>11 DEF Phase2b
     <2>12a. aDelivery
          BY DEF Assumptions     
     <2>13.  \E Q \in Quorums : \A a \in Q :
                                           Rule_2b_msg(a)  
                                         /\ \E m \in msgs : (m.type = "2a") /\ (m.prop = P1) /\ (maxBal[a]<=m.bal)      
                                         /\ \E t \in Time : Deliver([type |-> "2b", prop |-> m.prop, bal |-> m.bal, val |-> m.val, acc |-> a], t)
          BY <2>12, <2>12a DEF aDelivery
     <2>14.  \E Q \in Quorums : \A a \in Q :
                                           Rule_2b_msg(a)  
                                         /\ \E m \in msgs : (m.type = "2a") /\ (m.prop = P1) /\ (maxBal[a]<=m.bal)      
                                         /\ \E t \in Time : Deliver([type |-> "2b", prop |-> P1, bal |-> m.bal, val |-> m.val, acc |-> a], t)
          BY <2>13
     <2>15.  \E Q \in Quorums : \A a \in Q : \E m \in msgs : 
                                                         (m.type = "2a") 
                                                      /\ (m.prop = P1) 
                                                      /\ (maxBal[a]<=m.bal)      
                                                      /\ \E t \in Time :
                                                                /\ (state_time' = t) 
                                                                /\ msgs' = msgs \cup {[type |-> "2b", prop |-> m.prop, bal |-> m.bal, val |-> m.val, acc |-> a]}
          BY <2>13 DEF Deliver
     <2>15a.  \A Q \in Quorums: \A a \in Q: \A m \in msgs : \A t \in Time :
            ((msgs' = msgs \cup {[type |-> "2b", prop |-> m.prop, bal |-> m.bal, val |-> m.val, acc |-> a]})
            => ([type |-> "2b", prop |-> m.prop, bal |-> m.bal, val |-> m.val, acc |-> a] \in msgs'))
            OBVIOUS                    
     <2>16.  \E Q \in Quorums : \A a \in Q : \E m \in msgs : 
                                                         (m.type = "2a") 
                                                      /\ (m.prop = P1) 
                                                      /\ (maxBal[a]<=m.bal)      
                                                      /\ \E t \in Time :
                                                                ...
                                                                /\ [type |-> "2b", prop |-> m.prop, bal |-> m.bal, val |-> m.val, acc |-> a] \in msgs'
          BY <2>15, <2>15a
     <2>17.  \E Q \in Quorums : \A a \in Q : \E m \in msgs : 
                                                         (m.type = "2a") 
                                                      /\ (m.prop = P1) 
                                                      /\ (maxBal[a]<=m.bal)      
                                                      /\ \E t \in Time :
                                                                /\ (state_time' = t) 
                                                                /\ \E m2 \in msgs' : (m2.type = "2b") /\ (m2.prop = m.prop) /\ (m2.acc = a)
          BY <2>16
     <2>18.  \E Q \in Quorums : \A a \in Q :  \E t \in Time : (state_time' = t) /\ (\E m2 \in msgs' : (m2.type = "2b") /\ (m2.prop = P1) /\ (m2.acc = a))
          BY <2>17          
     <2>200. QED
            BY <2>18, <2>1
...
<1>3. (\E t \in Time : state_time' = t /\ (\E Q \in Quorums : \A a \in Q : (\E m \in msgs' : (m.type = "2b") /\ (m.prop = P1) /\ (m.acc = a))))
...
<1> SUFFICES ASSUME NEW P \in Proposers, 
            ...
            PROVE    (\E t \in Time : state_time' = t /\ (\E b \in Ballots : \E Q \in Quorums : \A a \in Q : (\E m \in msgs' : (m.type = "1b") /\ (m.prop = P) /\ (m.acc = a) /\ (m.bal = b))))
    OBVIOUS
...
<1>4.      /\ HighestProposer(P)
              /\ \E b \in Ballots :
                  ...
                  /\ (\A a \in Acceptors : \E m1 \in msgs : m1.type = "1a" /\ m1.prop = P  /\ m1.bal = b /\ maxBal[a]<b)
    BY <1>3, <1>2
<1>4a. \E b \in Ballots : \A a \in Acceptors : \E m1 \in msgs : m1.type = "1a" /\ m1.prop = P /\ m1.bal = b /\ maxBal[a]<m1.bal
    BY <1>4
<1>5. ASSUME (~(\E t \in Time : state_time' = t /\ \E b \in Ballots : (\E Q \in Quorums : \A a \in Q : (\E m \in msgs' : (m.type = "1b") /\ (m.prop = P) /\ (m.acc = a) /\ (m.bal = b)))))
      PROVE FALSE
      <2>1.\E b \in Ballots : \A a \in Acceptors : \E m1 \in msgs : m1.type = "1a" /\ m1.prop = P /\ m1.bal = b /\ maxBal[a]<m1.bal
          BY <1>4a
      ...
      <2>6. \E b \in Ballots : \E Q \in Quorums : \A a2 \in Q : \E m1 \in msgs : m1.type = "1a" /\ m1.prop = P /\ maxBal[a2]<m1.bal /\ m1.bal = b/\ Always_available(a2) /\ a2 \in Acceptors
           BY <2>5, <2>1
      <2>7. \E b \in Ballots : \E Q \in Quorums : \A a2 \in Q : \E m1 \in msgs : m1.type = "1a" /\ m1.prop = P /\ maxBal[a2]<m1.bal /\ m1.bal = b /\ Always_available(a2) /\ a2 \in Acceptors
           BY <2>6
      <2>8. \E b \in Ballots : \E Q \in Quorums : \A a2 \in Q : \E m1 \in msgs : m1.type = "1a" /\ m1.prop = P /\ m1.bal = b /\ maxBal[a2]<m1.bal /\ Always_available(a2)/\ a2 \in Acceptors                                                       
           BY <2>7
      ...
      <2>11a. (\E b \in Ballots : \E Q \in Quorums : \A a2 \in Q : 
                     \E m1 \in msgs : m1.type = "1a" /\ m1.prop = P /\ m1.bal = b /\ m1.bal>maxBal[a2])
      ...
      <2>14. \E b \in Ballots : \E Q \in Quorums : \A a \in Q : 
                     \E m \in msgs : m.type = "1a" /\ m.prop = P /\ m.bal = b 
                                   /\ \E t \in Time : Send([type |-> "1b", prop |-> m.prop, bal |-> m.bal, maxVBal |-> maxVBal[a], maxVal |-> maxVal[a], acc |-> a],t)                                    
           BY <2>13 DEF Phase1b 
      <2>15.  \E b \in Ballots : \E Q \in Quorums : \A a \in Q : 
                     \E m \in msgs : m.type = "1a" /\ m.prop = P /\ m.bal = b
                                   /\ \E t \in Time : Deliver([type |-> "1b", prop |-> m.prop, bal |-> m.bal, maxVBal |-> maxVBal[a], maxVal |-> maxVal[a], acc |-> a],t)                                    
           BY <2>14, <2>2 DEF aDelivery
      <2>16.  \E b \in Ballots : \E Q \in Quorums : \A a \in Q : 
                     \E m \in msgs : m.type = "1a" /\ m.prop = P /\ m.bal = b
                                   /\ \E t \in Time : state_time' = t
                                                     /\ msgs' = msgs \cup {[type |-> "1b", prop |-> m.prop, bal |-> m.bal, maxVBal |-> maxVBal[a], maxVal |-> maxVal[a], acc |-> a]}                                  
           BY <2>15 DEF Deliver
      <2>16a.\A b \in Ballots : \A Q \in Quorums : \A a \in Q : \A m \in msgs : \A t \in Time :
               ((msgs' = msgs \cup {[type |-> "1b", prop |-> m.prop, bal |-> m.bal, maxVBal |-> maxVBal[a], maxVal |-> maxVal[a], acc |-> a]})
               => [type |-> "1b", prop |-> m.prop, bal |-> m.bal, maxVBal |-> maxVBal[a], maxVal |-> maxVal[a], acc |-> a] \in msgs')
           OBVIOUS         
      ...
      <2>18. \E b \in Ballots : \E Q \in Quorums : \A a \in Q : 
                     \E m \in msgs : m.type = "1a" /\ m.prop = P /\ m.bal = b
                                   /\ \E t \in Time : state_time' = t
                                                     /\ \E m2 \in msgs' : m2.prop = P /\ m2.acc= a /\ m2.type = "1b" /\ m2.bal = b                                  
           BY <2>17
      <2>19. \E b \in Ballots : \E Q \in Quorums : \A a \in Q : 
                                   /\ \E t \in Time : state_time' = t
                                                     /\ \E m2 \in msgs' : m2.prop = P /\ m2.acc= a /\ m2.type = "1b" /\ m2.bal = b                                 
           BY <2>18
      <2>20.  \E b \in Ballots :  \E t \in Time : state_time' = t  /\ \E Q \in Quorums : \A a \in Q :    
                              \E m2 \in msgs' : m2.prop = P /\ m2.acc= a /\ m2.type = "1b" /\ m2.bal = b 
...
<1>7. (\E t \in Time : state_time' = t /\ (\E b \in Ballots : \E Q \in Quorums : \A a \in Q :  (\E m \in msgs' : (m.type = "1b") /\ (m.prop = P) /\ (m.acc = a) /\ (m.bal = b))))
...
<1> SUFFICES ASSUME NEW  P \in Proposers,
                      ...
                      /\ \E b \in Ballots : (\E Q \in Quorums : \A a \in Q : \E m \in msgs : (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P) /\ (m.acc = a))
                                         /\ (\E m \in msgs : (m.type = "2a") /\ (m.prop = P) /\ (m.bal = b)))
                      /\ Assumptions
             PROVE    (\E t \in Time : state_time' = t /\ (\E Q \in Quorums : \A a \in Q : (\E m \in msgs' : (m.type = "2b") /\ (m.prop = P) /\ (m.acc = a))))
    OBVIOUS
...
<1>5. HighestProposer(P) 
       /\ \E b \in Ballots : (\E Q \in Quorums : \A a \in Q : \E m \in msgs : (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P) /\ (m.acc = a))
                                         /\ (\E m \in msgs : (m.type = "2a") /\ (m.prop = P)  /\ (m.bal = b) 
                                         /\  (\A a \in Acceptors : \E m1 \in msgs : m1.type = "2a" /\ m1.prop = P /\ maxBal[a]<=b ))
...
<1>5c. \E P \in Proposers : HighestProposer(P) 
                        /\ Always_available(P) 
                        /\ (\E t2 \in Time : state_time' = t2 
                                        /\ \E b \in Ballots : 
                                            (\E m \in msgs' : m.type = "1a" /\ m.prop = P /\ m.bal = b)
                                       ...
                                       /\ (~(\E m2 \in msgs': m2.type = "2b" /\ m2.prop = P)) )                                                      
    BY <1>5a, Lemma1
<1>6. \E P \in Proposers : HighestProposer(P) 
                        /\ Always_available(P) 
                        /\ (\E t2 \in Time : state_time = t2 
                                        /\ \E b \in Ballots : 
                                            (\E m \in msgs : m.type = "1a" /\ m.prop = P /\ m.bal = b)
...
<1>2. \E P \in Proposers :
                     HighestProposer(P)                   
                   /\ (\E t \in Time : state_time = t /\ \E b \in Ballots : (\E m \in msgs : m.type = "1a" /\ m.prop = P /\ m.bal = b)
                                /\ (~(\E m2 \in msgs: m2.type = "1b" /\ m2.prop = P)))
...
<1>4.  \E P \in Proposers :
                     HighestProposer(P)                   
                   /\ Always_available(P)   
                   /\ (\E t \in Time : state_time = t /\ Available(P,t) /\ \E b \in Ballots : (\E m \in msgs : m.type = "1a" /\ m.prop = P /\ m.bal = b)
                                /\ (~(\E m2 \in msgs: m2.type = "1b" /\ m2.prop = P)))      
...
<1>21. TemporalProperty3
     BY <1>2a DEF TemporalProperties
<1>22. \A P \in Proposers: \A t \in Time: 
         ((state_time' = t 
           /\ (\E b \in Ballots : 
               \E Q \in Quorums : 
                \A a \in Q : 
...
<1>23.    (\E P \in Proposers : HighestProposer(P)  
            /\ (\E t \in Time : state_time = t 
               /\ (\E b \in Ballots : 
                   \E Q \in Quorums : 
                    \A a \in Q : 
                     (\E m \in msgs : (m.type = "1b") /\ (m.prop = P) /\ (m.acc = a) /\ (m.bal = b)))))
     BY <1>20, <1>22 
...
<1>7. (\E P \in Proposers : HighestProposer(P)  
                       /\  (\E t2 \in Time : state_time = t2 
                                         /\ \E b \in Ballots :  (\E Q \in Quorums : \A a \in Q : \E m \in msgs : (m.type = "1b") /\ (m.bal = b)  /\ (m.prop = P) /\ (m.acc = a)) 
                                                             /\ (\E m \in msgs : m.type = "2a" /\ m.prop = P /\ m.bal = b)) ) 
    BY <1>5, <1>6 
...
(
    (\E P \in Proposers :
         HighestProposer(P)
      /\ (\E t \in Time : state_time = t /\ msgsPost2b(P))) 
)
<1> SUFFICES ASSUME Assumptions,  (\E P \in Proposers : HighestProposer(P) /\ \E t \in Time : state_time = t /\ msgsPost2a(P))
             PROVE
                    (\E P \in Proposers :
                         HighestProposer(P)
                      /\ (\E t \in Time : state_time = t /\ msgsPost2b(P)))              
...
<1>5.(\E P \in Proposers :
         HighestProposer(P)
      /\ (\E t \in Time : state_time' = t /\ (\E Q \in Quorums : \A a \in Q : (\E m \in msgs' : (m.type = "2b") /\ (m.prop = P) /\ (m.acc = a)))))                                                      
    BY <1>4, Lemma5
<1>6.\A t \in Time:
     \A P \in Proposers:   
         ((state_time' = t 
...
\* Last modified Mon Dec 09 20:39:44 EST 2019 by pauls
